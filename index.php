...
if (!empty($_POST)){
	...
	$sql = "SELECT idusuarios FROM usuarios WHERE  usuario = '$usuario ' AND PasswordU = '$password_encriptada'";
...
if($filas > 0){
	...
	$sqlusuario = "INSERT INTO usuarios(NombreC,Correo,Usuario,PasswordU) 
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i><img src="https://img.icons8.com/stickers/50/000000/cat-footprint.png"/></i>
									<span class="red">Veterinaria </span>
									<span class="white" id="id-text2">Mascotas</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Todos los derechos reservados Juan Ramirez, Miriam y Cecilia</h4>
							</div>
